...
@section('title', ($lang === 'bn' ? 'আমরা কারা - প্রিমিয়ার মেডিকেল হাউসকল' : 'Who We Are - Premier Medical Housecall'))

@section('description', ($lang === 'bn' ? 'প্রিমিয়ার মেডিকেল হাউসকল সম্পর্কে জানুন, আমাদের মিশন, মূল্যবোধ এবং ব্যতিক্রমী স্বাস্থ্যসেবা প্রদানের প্রতিশ্রুতি।' : 'Learn about Premier Medical Housecall, our mission, values, and commitment to providing exceptional healthcare services.'))

@section('keywords', ($lang === 'bn' ? 'আমাদের সম্পর্কে, মেডিকেল হাউসকল, স্বাস্থ্যসেবা, আমাদের মিশন, আমাদের মূল্যবোধ' : 'about us, medical housecall, healthcare services, our mission, our values'))
    ...
    <script>
        ...
        if (currentLang === 'bn') {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Also convert stat-number elements
                const statNumbers = document.querySelectorAll('.stat-number');
                statNumbers.forEach(stat => {
                    const observer = new MutationObserver(function(mutations) {
                        const text = stat.textContent;
                        if (/[0-9]/.test(text)) {
                            stat.textContent = convertToBengaliNumerals(text);
                        }
                    });
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 class="heading-title">{{ $lang === 'bn' ? 'আমাদের সম্পর্কে' : 'About' }}</h1>
              <p class="mb-0">
                {{ $lang === 'bn'
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">{{ $lang === 'bn' ? 'আমাদের সম্পর্কে' : 'About' }}</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
