...
<div class="container-fluid px-4 py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-3" style="color: #2c3e50; font-weight: 600;">Edit Coverage Area</h1>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.coverage-areas.update', $coverageArea) }}" class="form-container">
        @csrf
        @method('PUT')
            ...
            <div class="card-body" style="padding: 20px;">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $coverageArea->title_en) }}" placeholder="Enter coverage area title in English" required>
                        @error('title_en')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('title_bn') is-invalid @enderror" id="title_bn" name="title_bn" value="{{ old('title_bn', $coverageArea->title_bn) }}" placeholder="কভারেজ এরিয়ার শিরোনাম">
                        @error('title_bn')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-body" style="padding: 20px;">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="3" placeholder="Enter coverage area description in English">{{ old('description_en', $coverageArea->description_en) }}</textarea>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('description_bn') is-invalid @enderror" id="description_bn" name="description_bn" rows="3" placeholder="কভারেজ এরিয়ার বর্ণনা লিখুন">{{ old('description_bn', $coverageArea->description_bn) }}</textarea>
            ...
            <div class="card-body" style="padding: 20px;">
                <div class="mb-3">
                    <div class="form-check" style="padding-left: 1.5rem;">
                        <input class="form-check-input" type="checkbox" id="show_on_home" name="show_on_home" value="1" {{ old('show_on_home', $coverageArea->show_on_home) ? 'checked' : '' }} style="width: 20px; height: 20px; cursor: pointer;">
                ...
                <div class="mb-0">
                    ...
                    <input type="number" class="form-control @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order', $coverageArea->order) }}" min="0" placeholder="Enter order number (0, 1, 2, ...)">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button type="submit" class="btn btn-primary btn-lg" style="padding: 10px 40px; border-radius: 6px; font-weight: 600;">
                <i class="fas fa-save"></i> Update Coverage Area
            </button>
        </div>
    </form>
</div>
