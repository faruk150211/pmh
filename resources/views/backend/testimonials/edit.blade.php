...
<div class="container-custom">
    ...
    <div class="page-header mb-4">
        <h1 style="color: #333; font-size: 28px; margin-bottom: 10px;">Edit Testimonial</h1>
        <p style="color: #666;">Update customer testimonial content</p>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title_en" id="title_en"
                    value="{{ old('title_en', $testimonial->title_en) }}"
            ...
            <div class="form-group">
                ...
                <textarea name="content_en" id="content_en" required
                    placeholder="Enter testimonial content in English">{{ old('content_en', $testimonial->content_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" name="author_en" id="author_en" required
                    value="{{ old('author_en', $testimonial->author_en) }}"
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title_bn" id="title_bn"
                    value="{{ old('title_bn', $testimonial->title_bn) }}"
            ...
            <div class="form-group">
                ...
                <textarea name="content_bn" id="content_bn" required
                    placeholder="বাংলায় সাক্ষ্যের বিষয়বস্তু">{{ old('content_bn', $testimonial->content_bn) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" name="author_bn" id="author_bn" required
                    value="{{ old('author_bn', $testimonial->author_bn) }}"
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="existing-image">
                    <p style="margin-bottom: 10px; color: #666;">Current Picture:</p>
                    <img src="{{ asset($testimonial->picture) }}" alt="Current Picture">
                    <br>
                    <button type="button" class="remove-image" onclick="removeExistingImage()">Change Picture</button>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="checkbox-group">
                <input type="checkbox" name="show_on_home" id="show_on_home" value="1"
                    {{ $testimonial->show_on_home ? 'checked' : '' }}>
    ...
    <script>
        ...
        function removeExistingImage() {
            ...
            document.querySelector('.existing-image').style.display = 'none';
        }
